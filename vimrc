...
set hidden "keep an undo history for multiple files when re-using the same window 
...
" Set the gui font family and groups and othe gui options
if has("gui_running")
  if has("gui_gtk2")
  ...
  elseif has("gui_win32")
    ...
    set guioptions +=m "Shows the menubar
